...
MAIN_URL = 'https://www.beko.com.tr/'
...
def category_page_links(MAIN_URL):
    '''
    INPUT: https://www.beko.com.tr/

    OUTPUT: https://www.beko.com.tr/beyaz-esya  type:list
            https://www.beko.com.tr/derin-dondurucu
    '''
    ...
    for category_index in range(len(features_raw)):
        category_links.append(str(MAIN_URL) + str(features_raw[category_index].find("a").get(
            "href")))
...
def product_group_links(category_link):
    """
    INPUT: https://www.beko.com.tr/beyaz-esya

    OUTPUT: https://www.beko.com.tr/bulasik-makinesi
            https://www.beko.com.tr/buzdolabi
    """
    category_url_soup = get_html(category_link)
    category_raw = category_url_soup.find('ul', attrs={'class': 'ul-clear category-list'}).find_all(
        "li")
    product_group_page = []
...
def numberOfPages(product_group_page):
    ...
    numberofPages_real = json.loads(
        numberOfPages_soup.find("div", attrs={"class": "col-12 productGridPage-page"}).find("span", attrs={
            "data-options": True}).get("data-options"))["numberOfPages"]
...
def collecting_product_links(product_group_page):
    """
    INPUT: https://www.beko.com.tr/buzdolabi

    OUTPUT: list of urls --> https://www.beko.com.tr/no-frost-buzdolabi/670482-mi-buzdolabi
    """
...
def collection_product_detail(product_links):
    ...
    for product in product_links:
        ...
        for v_element in v_elements:
            ...
            if t_element is not None and feature not in features:  ## To not count duplicate products again
        ...
        link = "https://www.beko.com.tr/" + srcset.split(",")[0]
